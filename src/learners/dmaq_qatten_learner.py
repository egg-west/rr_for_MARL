...
class DMAQ_qattenLearner:
    ...
    def sub_train(self, batch: EpisodeBatch, t_env: int, episode_num: int, mac, mixer, optimiser, params,
        ...
        for t in range(batch.max_seq_length):
            agent_outs, _ = mac.forward(batch, t=t)
        ...
        if t_env - self.log_stats_t >= self.args.learner_log_interval:
            ...
            train_stats["train/hit_prob"] = hit_prob.item()
            train_stats["train/grad_norm"] = grad_norm
    ...
    def train(self, batch: EpisodeBatch, t_env: int, episode_num: int, show_demo=False, save_data=None, task_id=None):
