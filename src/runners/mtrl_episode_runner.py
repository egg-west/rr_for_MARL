...
class MTRLRunner:
    ...
    def __init__(self, args, logger, wandb_logger=None, env_id=None):
        ...
        self.t_env = 0 # the number of episodes haved run
    ...
    def run(self, test_mode=False, agent_embedding=None):
        ...
        #obs_list.append(self.env.get_obs())
        #availA_list.append(self.env.get_avail_actions())
        if test_mode and self.args.render:
        ...
        if self.mac.action_selector is not None:
        ...
        # if self.args.availA_contrastive:
        #     return self.batch, timely_test_stats, obs_list, availA_list
        # else:
        #return self.batch, timely_test_stats
        stats_to_return = [[episode_return], [env_info.get("battle_won", 0)], self.t_env]
